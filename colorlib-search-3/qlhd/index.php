...
<div class="s003">
    <h2 style="text-align: center;margin-bottom: 40px;margin-top: 40px;font-weight: bolder">Danh sách hợp đồng</h2>
                ...
                <?php if(isset($data1)) : ?>
                    <?php if(isset($data1)) :?>
                        <?php foreach ($data1 as $key=>$post) :?>
                            ...
                            <tr>
                                <td><a href="create.php" class="btn btn-primary create" style="margin-right: 15px"><i class="fas fa-plus-circle"></i> Thêm hợp đồng</a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <?php if(isset($data)) :?>
                        ...
                        <tr>
                            <td colspan="9" style="text-align: center">
                                <a class="create1" href="create.php"><i class="fas fa-plus-circle" style="color: #007bff">      Thêm hợp đồng</i></a>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endif; ?>
