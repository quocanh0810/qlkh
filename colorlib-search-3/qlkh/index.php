...
if(isset($_POST["search"])){
    ...
    if($search_id == "makh"){
        $sql_search = "SELECT * FROM khachhang WHERE MaKH LIKE '$search_text%'";
    }
    if($search_id == "tenkh"){
        $sql_search = "SELECT * FROM khachhang WHERE TenKH LIKE '$search_text%'";
    }
...
<div class="s003">
    <h2 style="text-align: center;margin-bottom: 40px;margin-top: 40px;font-weight: bolder">Danh sách khách hàng</h2>
                    ...
                    <?php if(isset($data1)) :?>
                        <?php foreach ($data1 as $key=>$post) :?>
                            <tr>
                                ...
                                <td><?php echo $post["TenKH"]; ?></td>
                                <td><?php echo $post["QuyMoDN"]; ?></td>
                                <td><?php echo $post["LinhVucKD"]; ?></td>
                                <td><?php echo $post["DiaChi"]; ?></td>
                                <td><?php echo $post["SDT"]; ?></td>
                                <td><?php echo $post["Email"]; ?></td>
                                <td>
                                    <a href="edit.php?makh=<?php echo $post["MaKH"];?>" class="btn btn-primary" style="margin-right: 15px" ><i class="fas fa-edit"></i></a>
                                    <a href="#" data-id="<?php echo $post["MaKH"]?>" data-target="#delete-client-modal" class="btn btn-danger clickDelete"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <?php if(isset($data)) :?>
                        ...
                        <tr>
                            <td colspan="8" style="text-align: center">
                                <a class="create1" href="create.php"><i class="fas fa-plus-circle" style="color: #007bff">      Thêm khách hàng</i></a>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endif; ?>
    ...
    <div>
        <div class="deleteConfirmed" style="display:none;">
            ...
            <div class="delete-box">
                ...
                <h5>Bạn có chăc muốn xóa khách hàng này không?</h5>
            </div>
    ...
    $('.clickDelete').each(function () {
        ...
        $this.on("click", function () {
            ...
            $('.delete-btn').click(function(){
                window.location = "http://localhost/colorlib-search-3/process/qlkh/handleDelete.php?delete=" + id;
            });
        });
    });
    //
